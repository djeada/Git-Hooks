...
if __name__ == '__main__':
    ...
    # call python script 'python docstring_physician.py file_path' with subprocess and then check if file was changed
    ...
    for line_result, line_expected in zip(result.splitlines(), expected.splitlines()):
        assert line_result.strip() == line_expected.strip()


def test_correct_file(tmpdir):
    file_content = '''
"""
