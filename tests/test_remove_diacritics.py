...
original_content = "Chwale nami soplicą wyciągała krucze podano. \n" \
...
expected_content = "Chwale nami soplica wyciagala krucze podano. \n" \
...
def test_remove_diacritics(tmpdir):
    ...
    for result_line, expected_line in zip(file_name.read().split('\n'), expected_content.split('\n')):
