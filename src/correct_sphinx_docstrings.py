    ...
    def convert(self):
        ...
        for i in range(1, end_index):
            ...
            for word in line.split():
                ...
                if previous_word.lower() not in self.blocking_words and previous_word.lower() not in self.verbs:
